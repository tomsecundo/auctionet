        ...
        <div key={task.id} className="bg-gray-100 p-4 mb-4 rounded shadow">
          ...
          <div className="mt-2 flex">
            <button
              ...
              className="mr-2 bg-orange-500 text-white px-4 py-2 rounded flex inline hover:bg-orange-700"
            >
            ...
            <button
              ...
              className="bg-red-500 text-white px-4 py-2 rounded flex hover:bg-red-700"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
